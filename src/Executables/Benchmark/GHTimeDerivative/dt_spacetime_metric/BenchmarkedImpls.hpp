...
struct BenchmarkImpl {
  ...
  SPECTRE_ALWAYS_INLINE static void tensorexpression_impl_lhs_arg<1>(
    ...
    tenex::evaluate<ti::a, ti::b>(
        ...
        -1.0 * lapse() * pi(ti::a, ti::b) +
            gamma1_plus_1() * shift_dot_three_index_constraint(ti::a, ti::b) +
  ...
  SPECTRE_ALWAYS_INLINE static void tensorexpression_impl_lhs_arg<2>(
    ...
    tenex::evaluate<ti::a, ti::b>(
        dt_spacetime_metric,
        shift(ti::I) * phi(ti::i, ti::a, ti::b) + -1.0 * lapse() * pi(ti::a, ti::b) +
            gamma1_plus_1() * shift_dot_three_index_constraint(ti::a, ti::b));
  }
  ...
  SPECTRE_ALWAYS_INLINE static void tensorexpression_impl_lhs_arg<3>(
    ...
    tenex::evaluate<ti::a, ti::b>(
        dt_spacetime_metric,
        -1.0 * lapse() * pi(ti::b, ti::a) +
            gamma1_plus_1() * shift_dot_three_index_constraint(ti::b, ti::a) +
            shift(ti::I) * phi(ti::i, ti::b, ti::a));
  }
  ...
  tensorexpression_impl_lhs_return(const lapse_type& lapse, const pi_type& pi,
    ...
    return tenex::evaluate<ti::a, ti::b>(
        -1.0 * lapse() * pi(ti::a, ti::b) +
        gamma1_plus_1() * shift_dot_three_index_constraint(ti::a, ti::b) +
        shift(ti::I) * phi(ti::i, ti::a, ti::b));
  }
