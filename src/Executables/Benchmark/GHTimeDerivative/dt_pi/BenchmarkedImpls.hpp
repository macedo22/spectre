  ...
  SPECTRE_ALWAYS_INLINE static void tensorexpression_impl_lhs_arg<1>(
    ...
    tenex::evaluate<ti::a, ti::b>(
        ...
        (-spacetime_deriv_gauge_function(ti::a, ti::b) -
         ...
         gamma0() * (normal_spacetime_one_form(ti::a) * gauge_constraint(ti::b) +
         ...
         // Note : flipped ti::b and ti::a in next product so test passes
         // (symmetry asusmption issues)
         2.0 * phi_3_up(ti::i, ti::a, ti::C) * phi_1_up(ti::I, ti::b, ti::c) -
         ...
         inverse_spatial_metric(ti::J, ti::K) * d_phi(ti::j, ti::k, ti::a, ti::b)) *
                lapse() +
