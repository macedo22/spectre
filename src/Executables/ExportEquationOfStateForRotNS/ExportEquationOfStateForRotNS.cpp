...
struct NumberOfPoints {
  using type = size_t;
  Options::String help = {"Number of points at which to dump the EoS"};
};
...
struct LowerBoundRestMassDensityCgs {
  using type = double;
  Options::String help = {"Lower bound of rest mass density in CGS units."};
};

struct UpperBoundRestMassDensityCgs {
  using type = double;
  Options::String help = {"Upper bound of rest mass density in CGS units."};
};
}  // namespace OptionTags
}  // namespace
