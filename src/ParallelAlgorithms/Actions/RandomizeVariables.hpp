...
struct RandomizeVariables {
 public:
  ...
  struct RandomParameters {
    struct Amplitude {
      using type = double;
      Options::String help = "Amplitude of the uniform noise.";
    };
    struct Seed {
      using type = Options::Auto<size_t>;
      Options::String help = "Random seed for the noise generator.";
    };
    using options = tmpl::list<Amplitude, Seed>;
    Options::String help = "Parameters for the uniform noise.";
    void pup(PUP::er& p) {
      p | amplitude;
      p | seed;
    }
  ...
  struct RandomParametersOptionTag {
    ...
    Options::String help = "Add uniform random noise to variables.";
  };
