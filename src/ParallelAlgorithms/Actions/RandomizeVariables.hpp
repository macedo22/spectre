...
struct RandomizeVariables {
 public:
  ...
  struct RandomParameters {
    struct Amplitude {
      using type = double;
      static Options::String help = "Amplitude of the uniform noise.";
    };
    struct Seed {
      using type = Options::Auto<size_t>;
      static Options::String help = "Random seed for the noise generator.";
    };
    using options = tmpl::list<Amplitude, Seed>;
    static Options::String help = "Parameters for the uniform noise.";
    void pup(PUP::er& p) {
      p | amplitude;
      p | seed;
    }
  ...
  struct RandomParametersOptionTag {
    ...
    static Options::String help = "Add uniform random noise to variables.";
  };
