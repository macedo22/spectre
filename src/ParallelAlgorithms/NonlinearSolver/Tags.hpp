...
struct SufficientDecrease {
  using type = double;
  Options::String help = {"Fraction of decrease predicted by linearization"};
...
struct DampingFactor {
  using type = double;
  Options::String help = {"Multiply corrections by this factor"};
  static type lower_bound() { return 0.; }
  static type upper_bound() { return 1.; }
...
struct MaxGlobalizationSteps {
  using type = size_t;
  Options::String help = {"Maximum number of globalization steps"};
