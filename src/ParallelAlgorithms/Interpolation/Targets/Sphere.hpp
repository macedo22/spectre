...
struct Sphere {
  ...
  struct Center {
    ...
    static Options::String help = {"Center of every sphere"};
  };
  struct Radius {
    using type = std::variant<double, std::vector<double>>;
    static Options::String help = {"Radius of the sphere(s)"};
  };
  ...
  static Options::String help = {"An arbitrary number of spherical surface."};
...
struct Sphere {
  ...
  static Options::String help{"Options for interpolation onto a sphere(s)."};
