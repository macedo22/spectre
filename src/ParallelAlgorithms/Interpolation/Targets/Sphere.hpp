...
struct Sphere {
  ...
  struct Center {
    ...
    Options::String help = {"Center of every sphere"};
  };
  struct Radius {
    using type = std::variant<double, std::vector<double>>;
    Options::String help = {"Radius of the sphere(s)"};
  };
  ...
  Options::String help = {"An arbitrary number of spherical surface."};
...
struct Sphere {
  ...
  Options::String help{"Options for interpolation onto a sphere(s)."};
