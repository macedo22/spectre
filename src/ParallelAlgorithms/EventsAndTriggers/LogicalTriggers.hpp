...
class Always : public Trigger {
 public:
  ...
  Options::String help = {"Always trigger."};
...
class Not : public Trigger {
 public:
  ...
  Options::String help = {"Negates another trigger."};
...
class And : public Trigger {
 public:
  ...
  Options::String help = {"Short-circuiting logical AND of other triggers."};
...
class Or : public Trigger {
 public:
  ...
  Options::String help = {"Short-circuiting logical OR of other triggers."};
