...
Main<Metavariables>::Main(CkArgMsg* /*msg*/) {
  ...
  //         }}(std::bool_constant<has_options>{}, tmpl::type_<Metavariables>{},
  //         0);
  ...
  // there are 46 options total
  options.template apply<tmpl::list<tmpl::at_c<option_list, 0>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 1>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 2>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 3>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 4>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 5>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 6>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 7>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 8>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 9>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 10>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 11>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 12>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 13>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 14>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 15>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 16>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 17>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 18>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 19>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 20>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 21>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 22>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 23>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 24>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 25>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 26>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 27>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 28>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 29>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 30>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 31>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 32>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 33>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 34>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 35>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 36>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 37>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 38>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 39>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 40>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 41>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 42>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 43>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 44>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  options.template apply<tmpl::list<tmpl::at_c<option_list, 45>>, Metavariables>([](auto... args) {
    (void)std::initializer_list<char>{((void)args, '0')...};
  });
  ...
  //       // Include a check that the checkpoint dirs are available for writing
  //       as
  //       // part of checking the option parsing. Doing these checks together
  //       helps
  ...
  //       // constructor because we don't _always_ want to error if checkpoint
  //       dirs
  //       // already exist. For example, running the executable with flags like
  //       // `--help` or `--dump-source-tree-as` should succeed even if
  //       checkpoints
  ...
  //   // Now that the GlobalCache has been built, create the singleton map
  //   which
  //   // will be used to allocate all the singletons. We need to be careful
  //   here
  //   // because the parallel components have not been set at this point, so if
  //   we
  //   // try to Parallel::get_parallel_component here, an error will occur.
  //   This
  //   // call is OK though because build_singleton_map() only uses the parallel
  //   info
  ...
  //   // Now that the singleton map has been built, set the resource info in
  //   the
  //   // GlobalCache (if the tags exist). Since this info will be constant
  //   // throughout a simulation, we opt for directly editing a const tag in
  //   the
  //   // GlobalCache before we pass it to any other parallel component rather
  //   than
  ...
  //   // ResourceInfo that was created from options with the one that has all
  //   the
  //   // correct singleton assignments so simple tags can be created from
  //   options
  ...
  //     tmpl::type_from<decltype(parallel_component_v)>; using chare_type =
  //     typename parallel_component::chare_type; using charm_type =
  //     Parallel::charm_types_with_parameters<
  //         parallel_component, typename Parallel::get_array_index<
  //                                 chare_type>::template
  //                                 f<parallel_component>>;
  //     Parallel::printf(
  ...
  //         tmpl::size<
  //             typename
  //             charm_type::algorithm::databox_type::tags_list>::value);
  //   });
  //   Parallel::printf("\n");
  // #endif  // SPECTRE_DEBUG
  ...
  //     using parallel_component =
  //     tmpl::type_from<decltype(parallel_component_v)>; using
  //     ParallelComponentProxy =
  ...
  //   // Create proxies for empty array chares (whose elements will be created
  //   by
  ...
  //             typename
  //             tmpl::type_from<decltype(parallel_component)>::bind_to>>>(
  //             the_parallel_components));
  //     tuples::get<tmpl::type_<ParallelComponentProxy>>(the_parallel_components)
  //     =
  ...
  //   // Create proxies for singletons (which are single-element charm++
  //   arrays)
...
void Main<Metavariables>::pup(PUP::er& /*p*/) {  // NOLINT
  ...
  // // For now we only support restarts on the same hardware configuration
  // (same
  // // number of nodes and same procs per node) used when writing the
  // checkpoint.
...
void Main<Metavariables>::
  ...
  //   const size_t proc = resource_info_.template
  //   proc_for<singleton_component>();
  ...
  //       Parallel::create_from_options<Metavariables>(
  //           options_, typename
  //           parallel_component::simple_tags_from_options{}),
...
void Main<Metavariables>::execute_next_phase() {
  ...
  //     Parallel::printf(
  //         "Received termination while cleaning up a previous termination.
  //         This " "is cyclic behavior and cannot be supported. Cleanup must
  ...
  //       Parallel::printf("Entering phase from phase control: %s at time
  //       %s\n",
  ...
  // // Here we handle phases with direct Charm++ calls. By handling these
  // phases
  // // after calling each component's execute_next_phase entry method, we
  // ensure
  ...
  // // component::execute_next_phase to make the direct charm calls. Instead,
  // the
...
void Main<Metavariables>::phase_change_reduction(
  ...
  //     std::decay_t<decltype(reduction_data.data())>>>;
...
void Main<Metavariables>::did_all_elements_terminate(
  ...
  //     if constexpr
  //     (detail::is_run_deadlock_analysis_simple_actions_callable_v<
  ...
  //           std::vector<std::string>& deadlocked_components);\n" "to your
  //           metavariables.\n");
  //     }
  //   }
...
void Main<Metavariables>::check_future_checkpoint_dirs_available() const {
  ...
  // // Find existing files with names that match the checkpoint dir name
  // pattern const auto all_files = file_system::ls(checkpoints_dir); const
  // std::regex re(prefix + "[0-9]{" + std::to_string(pad) + "}");
