...
struct DefaultElementsAllocator
  ...
  static void apply(
    ...
    // Note that the quadrature is arbitrarily chosen since it will not affect
    // the element distribution given that a uniform distribution does not
    // depend on quadrature
