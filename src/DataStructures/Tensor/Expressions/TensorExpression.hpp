...
/// the generic index order is the same. In these cases,
/// `TensorExpressions::update` should be used instead of
/// `TensorExpressions::evaluate`. See the documentation for
/// `TensorExpressions::update` for more details and
/// `TensorExpressions::detail::evaluate_impl` for why this is safe to do.
///
...
/// it and update the result component being accumulated.
