...
struct Divide : public TensorExpression<
  ...
  /// The number of tensor indices in the right operand expression, which may be
  /// non-zero if all of the indices are concrete time indices
  ...
  /// down the right child's subtree
