...
void dot_product(
  ...
  Parallel::printf("\n=== begin void dot_product() ===\n");
  // Parallel::printf("&vector_a (address of vector_a): %p\n",
  // (void*)&vector_a); Parallel::printf("vector_a.size(): %d\n",
  // vector_a.size()); Parallel::printf("&vector_b (address of vector_b): %p\n",
  // (void*)&vector_b); Parallel::printf("vector_b.size(): %d\n",
  // vector_b.size()); Parallel::printf("&dot_product (address of dot_product):
  // %p\n",
  //                  (void*)&dot_product);
  ...
  //     Parallel::printf(
  //         "&(*(vector_a[%d])) (address of vector_a[i] Datavector data):
  //         %p\n", i, (void*)&(*(vector_a[i])));
  //     Parallel::printf(
  //         "&(*(vector_b[%d])) (address of vector_b[i] Datavector data):
  //         %p\n", i, (void*)&(*(vector_b[i])));
  //   }
  // }
