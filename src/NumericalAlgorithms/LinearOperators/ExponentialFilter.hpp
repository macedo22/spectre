...
class Exponential {
 public:
  ...
  struct Alpha {
    using type = double;
    Options::String help = "exp(-alpha) is rescaling of highest coefficient";
  ...
  struct HalfPower {
    using type = unsigned;
    Options::String help = "Half of the exponent in the generalized Gaussian";
  ...
  struct Enable {
    using type = bool;
    Options::String help = {"Enable the filter"};
  };
  ...
  Options::String help = {"An exponential filter."};
