...
// // TODO: note that ResultTags is the Tags::deriv<EvolveVars...>
// template <typename ResultTags, typename VariableTags, size_t Dim>
// void logical_partial_derivatives(
//     const gsl::not_null<Variables<ResultTags>*>
//         logical_partial_derivatives_of_u,
//     const Variables<VariableTags>& u, const Mesh<Dim>& mesh) {
...
//     logical_partial_derivatives_of_u->initialize(number_of_grid_points);
//   }
...
// //   std::array<Variables<VariableTags>, Dim> logical_partial_derivs_local{};
// //   for (size_t i = 0; i < Dim; i++) {
// //     gsl::at(logical_partial_derivs_local, i).set_data_ref(
