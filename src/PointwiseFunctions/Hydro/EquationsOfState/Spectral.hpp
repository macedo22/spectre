...
class Spectral : public EquationOfState<true, 1> {
 public:
  ...
  struct ReferencePressure {
    using type = double;
    static Options::String help = {"Reference pressure p_0"};
    static double lower_bound() { return 0.0; }
  };

  struct Coefficients {
    using type = std::vector<double>;
    static Options::String help = {"Spectral coefficients gamma_i"};
  };

  struct UpperDensity {
    using type = double;
    static Options::String help = {"Upper density rho_u"};
    static double lower_bound() { return 0.0; }
  };
