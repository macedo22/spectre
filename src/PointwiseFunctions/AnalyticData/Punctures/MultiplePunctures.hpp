...
struct Puncture {
  struct Position {
    ...
    static Options::String help{"The position C of the puncture"};
  };
  struct Mass {
    using type = double;
    static Options::String help{"The puncture mass (bare mass) M"};
  ...
  static Options::String help{"A puncture representing a black hole"};
...
class MultiplePunctures : public elliptic::analytic_data::Background,
 ...
 public:
  ...
  static Options::String help = "Any number of black holes";
