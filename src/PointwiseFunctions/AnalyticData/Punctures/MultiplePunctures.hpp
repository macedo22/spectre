...
struct Puncture {
  struct Position {
    ...
    Options::String help{"The position C of the puncture"};
  };
  struct Mass {
    using type = double;
    Options::String help{"The puncture mass (bare mass) M"};
  ...
  Options::String help{"A puncture representing a black hole"};
...
class MultiplePunctures : public elliptic::analytic_data::Background,
 ...
 public:
  ...
  Options::String help = "Any number of black holes";
