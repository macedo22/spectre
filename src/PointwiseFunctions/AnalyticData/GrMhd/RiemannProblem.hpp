...
class RiemannProblem : public evolution::initial_data::InitialData,
 ...
 public:
  ...
  struct Lapse {
    using type = double;
    Options::String help() {
      return "The value of the lapse. Standard is 1.";
    }
    static type lower_bound() { return 0.0; }
  };
  struct ShiftX {
    using type = double;
    Options::String help() {
      return "The value of the x-component of the shift, beta^x. Standard is "
             "0.";
    }
  };
  ...
  Options::String help() {
    return "Analytic initial data for a GRMHD Riemann problem. The fluid "
           "variables "
