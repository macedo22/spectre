...
class MagneticFieldLoop
 ...
 public:
  ...
  struct RestMassDensity {
    using type = double;
    Options::String help = {"The constant density throughout the fluid."};
    static type lower_bound() { return 0.0; }
  };
  ...
  struct AdvectionVelocity {
    ...
    Options::String help = {"The advection velocity."};
  ...
  struct MagFieldStrength {
    using type = double;
    Options::String help = {"The magnitude of the magnetic field."};
    static type lower_bound() { return 0.0; }
  };
  ...
  struct InnerRadius {
    using type = double;
    Options::String help = {"The inner radius of the magnetic loop."};
    static type lower_bound() { return 0.0; }
  };
  ...
  struct OuterRadius {
    using type = double;
    Options::String help = {"The outer radius of the magnetic loop."};
    static type lower_bound() { return 0.0; }
  };
