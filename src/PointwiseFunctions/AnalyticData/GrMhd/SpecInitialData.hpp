 ...
 public:
  ...
  struct DataDirectory {
    ...
    static Options::String help() {
      return "Path to a directory of data produced by SpEC. The directory is "
             "expected to contain 'GrDomain.input' and 'Vars*.h5' files for "
             "all the "
  ...
  struct ElectronFraction {
    using type = double;
    static Options::String help() { return "Constant electron fraction"; }
  };
  ...
  static Options::String help() { return "Initial data generated by SpEC"; }
