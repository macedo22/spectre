...
class MagneticRotor : public evolution::initial_data::InitialData,
 ...
 public:
  ...
  struct RotorRadius {
    using type = double;
    static Options::String help = {"The initial radius of the rotor."};
    static type lower_bound() { return 0.0; }
  };
  /// Density inside the rotor.
  struct RotorDensity {
    using type = double;
    static Options::String help = {"Density inside RotorRadius."};
    static type lower_bound() { return 0.0; }
  };
  /// Density outside the rotor.
  struct BackgroundDensity {
    using type = double;
    static Options::String help = {"Density outside RotorRadius."};
    static type lower_bound() { return 0.0; }
  };
  /// Uniform pressure inside and outside the rotor.
  struct Pressure {
    using type = double;
    static Options::String help = {"Pressure."};
    static type lower_bound() { return 0.0; }
  };
  ...
  static Options::String help = {"Magnetic rotor analytic initial data."};
