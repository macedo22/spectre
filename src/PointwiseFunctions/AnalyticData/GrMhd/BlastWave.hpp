...
class BlastWave : public evolution::initial_data::InitialData,
 ...
 public:
  ...
  struct InnerRadius {
    using type = double;
    Options::String help = {"Inside InnerRadius, density is InnerDensity."};
    static type lower_bound() { return 0.0; }
  };
  /// Outside OuterRadius, density is OuterDensity.
  struct OuterRadius {
    using type = double;
    Options::String help = {"Outside OuterRadius, density is OuterDensity."};
    static type lower_bound() { return 0.0; }
  };
  /// Density at radii less than InnerRadius.
  struct InnerDensity {
    using type = double;
    Options::String help = {"Density at radii less than InnerRadius."};
    static type lower_bound() { return 0.0; }
  };
  /// Density at radii greater than OuterRadius.
  struct OuterDensity {
    using type = double;
    Options::String help = {"Density at radii greater than OuterRadius."};
    static type lower_bound() { return 0.0; }
  };
  /// Pressure at radii less than InnerRadius.
  struct InnerPressure {
    using type = double;
    Options::String help = {"Pressure at radii less than InnerRadius."};
    static type lower_bound() { return 0.0; }
  };
  /// Pressure at radii greater than OuterRadius.
  struct OuterPressure {
    using type = double;
    Options::String help = {"Pressure at radii greater than OuterRadius."};
    static type lower_bound() { return 0.0; }
  };
