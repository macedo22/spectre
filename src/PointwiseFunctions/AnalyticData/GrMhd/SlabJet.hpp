...
class SlabJet : public evolution::initial_data::InitialData,
 ...
 public:
  ...
  struct AmbientDensity {
    using type = double;
    Options::String help = {"Fluid rest mass density outside the jet"};
    static double lower_bound() { return 0.; }
    static double suggested_value() { return 10.; }
  };
  struct AmbientPressure {
    using type = double;
    Options::String help = {"Fluid pressure outside the jet"};
    static double lower_bound() { return 0.; }
    static double suggested_value() { return 0.01; }
  };
  struct AmbientElectronFraction {
    using type = double;
    Options::String help = {"Electron fraction outside the jet"};
    static double lower_bound() { return 0.; }
    static double upper_bound() { return 1.; }
  };
  struct JetDensity {
    using type = double;
    Options::String help = {"Fluid rest mass density of the jet inlet"};
    static double lower_bound() { return 0.; }
    static double suggested_value() { return 0.1; }
  };
  struct JetPressure {
    using type = double;
    Options::String help = {"Fluid pressure of the jet inlet"};
    static double lower_bound() { return 0.; }
    static double suggested_value() { return 0.01; }
  };
  struct JetElectronFraction {
    using type = double;
    Options::String help = {"Electron fraction of the jet inlet"};
    static double lower_bound() { return 0.; }
    static double upper_bound() { return 1.; }
  };
  struct JetVelocity {
    using type = std::array<double, 3>;
    Options::String help = {"Fluid spatial velocity of the jet inlet"};
  };
  struct InletRadius {
    using type = double;
    Options::String help = {"Radius of the jet inlet around y=0"};
    static double lower_bound() { return 0.; }
    static double suggested_value() { return 1.; }
  };
  struct MagneticField {
    using type = std::array<double, 3>;
    Options::String help = {"Initially uniform magnetic field"};
  ...
  Options::String help = {"Analytic initial data for a jet test."};
