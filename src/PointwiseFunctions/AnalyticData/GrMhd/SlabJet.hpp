...
class SlabJet : public evolution::initial_data::InitialData,
 ...
 public:
  ...
  struct AmbientPressure {
    using type = double;
    Options::String help() { return "Fluid pressure outside the jet"; }
    static double lower_bound() { return 0.; }
  ...
  struct JetPressure {
    using type = double;
    Options::String help() { return "Fluid pressure of the jet inlet"; }
    static double lower_bound() { return 0.; }
    static double suggested_value() { return 0.01; }
  };
  ...
  struct MagneticField {
    using type = std::array<double, 3>;
    Options::String help() { return "Initially uniform magnetic field"; }
