...
class BondiHoyleAccretion : public virtual evolution::initial_data::InitialData,
 ...
 public:
  ...
  struct BhMass {
    using type = double;
    Options::String help = {"The mass of the black hole."};
    static type lower_bound() { return 0.0; }
  };
  /// The dimensionless black hole spin, \f$a_* = a/M\f$.
  struct BhDimlessSpin {
    using type = double;
    Options::String help = {"The dimensionless black hole spin."};
  ...
  struct RestMassDensity {
    using type = double;
    Options::String help = {"The asymptotic rest mass density."};
    static type lower_bound() { return 0.0; }
  };
  /// The magnitude of the spatial velocity far from the black hole.
  struct FlowSpeed {
    using type = double;
    Options::String help = {"The magnitude of the asymptotic flow velocity."};
  };
  /// The strength of the magnetic field.
  struct MagFieldStrength {
    using type = double;
    Options::String help = {"The strength of the magnetic field."};
  };
  /// The polytropic constant of the fluid.
  struct PolytropicConstant {
    using type = double;
    Options::String help = {"The polytropic constant of the fluid."};
    static type lower_bound() { return 0.0; }
  };
  /// The polytropic exponent of the fluid.
  struct PolytropicExponent {
    using type = double;
    Options::String help = {"The polytropic exponent of the fluid."};
    static type lower_bound() { return 1.0; }
  };
