...
class ShuOsherTube : public MarkAsAnalyticData {
 public:
  ...
  struct LeftMassDensity {
    using type = double;
    Options::String help() { return "The left mass density."; }
    static type lower_bound() { return 0.0; }
  };

  struct LeftVelocity {
    using type = double;
    Options::String help() { return "The left velocity."; }
  };

  struct LeftPressure {
    using type = double;
    Options::String help() { return "The left pressure."; }
    static type lower_bound() { return 0.0; }
  };

  struct RightVelocity {
    using type = double;
    Options::String help() { return "The right velocity."; }
  };

  struct RightPressure {
    using type = double;
    Options::String help() { return "The right pressure."; }
    static type lower_bound() { return 0.0; }
  };

  struct Epsilon {
    using type = double;
    Options::String help() { return "Sinusoid amplitude."; }
    static type lower_bound() { return 0.0; }
  ...
  struct Lambda {
    using type = double;
    Options::String help() { return "Sinusoid wavelength."; }
  };

  Options::String help() {
    return "1D Shu-Osher oscillatory shock tube.";
  }
