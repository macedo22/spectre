...
class RotatingDipole : public evolution::initial_data::InitialData,
 ...
 public:
  struct VectorPotentialAmplitude {
    using type = double;
    Options::String help = {"The vector potential amplitude A_0"};
  };

  struct Varpi0 {
    using type = double;
    Options::String help = {"The length constant varpi_0"};
  ...
  struct AngularVelocity {
    using type = double;
    Options::String help = {"Rotation angular velocity of the star."};
