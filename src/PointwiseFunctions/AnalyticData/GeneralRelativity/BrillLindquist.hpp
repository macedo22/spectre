...
class BrillLindquist : public AnalyticDataBase<3>, public MarkAsAnalyticData {
 public:
  struct MassA {
    using type = double;
    static Options::String help = {"Mass of the black hole A"};
    static type lower_bound() { return 0.; }
  };
  struct MassB {
    using type = double;
    static Options::String help = {"Mass of the black hole B"};
    static type lower_bound() { return 0.; }
  };
  struct CenterA {
    using type = std::array<double, 3>;
    static Options::String help = {"The [x,y,z] center of the black hole A"};
  };
  struct CenterB {
    using type = std::array<double, 3>;
    static Options::String help = {"The [x,y,z] center of the black hole B"};
  };
  using options = tmpl::list<MassA, MassB, CenterA, CenterB>;
  static Options::String help{"Brill-Lindquist data for two black holes"};
