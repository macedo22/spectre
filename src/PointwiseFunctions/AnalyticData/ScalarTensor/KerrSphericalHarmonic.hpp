...
class KerrSphericalHarmonic
 ...
 public:
  ...
  struct Mass {
    using type = double;
    Options::String help = {"Mass of the black hole."};
    static type lower_bound() { return 0.0; }
  };
  /// The spin of the black hole
  struct Spin {
    using type = std::array<double, volume_dim>;
    Options::String help = {"The [x,y,z] dimensionless spin of the black hole"};
  };
  /// The amplitude of the scalar field
  struct Amplitude {
    using type = double;
    Options::String help = {"Amplitude of the constant scalar field"};
  };
  /// The location of the scalar field
  struct Radius {
    using type = double;
    Options::String help = {"The radius of the spherical harmonic profile"};
    static type lower_bound() { return 0.0; }
  };
