...
class CubicCrystal : public ConstitutiveRelation<3> {
 public:
  ...
  struct C_11 {
    using type = double;
    static Options::String help = {"c_11 parameter for a cubic crystal"};
    static type lower_bound() { return 0.0; }
  };

  struct C_12 {
    using type = double;
    static Options::String help = {"c_12 parameter for a cubic crystal"};
    static type lower_bound() { return 0.0; }
  };

  struct C_44 {
    using type = double;
    static Options::String help = {"c_44 parameter for a cubic crystal"};
    static type lower_bound() { return 0.0; }
  };
