...
class PlaneWave : public evolution::initial_data::InitialData,
 ...
 public:
  ...
  struct WaveVector {
    ...
    Options::String help = {"The direction of propagation of the wave."};
  };

  struct Center {
    using type = std::array<double, Dim>;
    Options::String help = {"The initial center of the profile of the wave."};
  };

  struct Profile {
    using type = std::unique_ptr<MathFunction<1, Frame::Inertial>>;
    Options::String help = {"The profile of the wave."};
  };
