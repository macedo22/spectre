...
class BentBeam : public elliptic::analytic_data::AnalyticSolution {
 public:
  ...
  struct Length {
    using type = double;
    Options::String help{"The beam length"};
    static type lower_bound() { return 0.0; }
  };
  struct Height {
    using type = double;
    Options::String help{"The beam height"};
    static type lower_bound() { return 0.0; }
  };
  struct BendingMoment {
    using type = double;
    Options::String help{"The bending moment applied to the beam"};
    static type lower_bound() { return 0.0; }
  };
  struct Material {
    using type = constitutive_relation_type;
    Options::String help{"The material properties of the beam"};
  };
