...
///
/// \note The previous time is calculated via the value of the
/// ::evolution::Tags::PreviousTriggerTime. This means that this tag can only be
/// used for dense triggers as that is where the
/// ::evolution::Tags::PreviousTriggerTime tag is set.
