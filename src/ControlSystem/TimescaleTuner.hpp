...
class TimescaleTuner {
 public:
  ...
  struct MinTimescale {
    using type = double;
    Options::String help = {"Minimum timescale"};
  };

  struct MaxTimescale {
    using type = double;
    Options::String help = {"Maximum timescale"};
  };

  struct DecreaseThreshold {
    using type = double;
    Options::String help = {"Threshold for decrease of timescale"};
  };
  struct IncreaseThreshold {
    using type = double;
    Options::String help = {"Threshold for increase of timescale"};
  };
  struct IncreaseFactor {
    using type = double;
    Options::String help = {"Factor to increase timescale"};
  };
  struct DecreaseFactor {
    using type = double;
    Options::String help = {"Factor to decrease timescale"};
  };
