...
struct Expansion : tt::ConformsTo<protocols::ControlError> {
  ...
  DataVector operator()(const ::TimescaleTuner<true>& /*unused*/,
    ...
    Parallel::printf("current_expansion_factor : %g", current_expansion_factor);
    Parallel::printf("grid_position_of_A : %g", grid_position_of_A);
    Parallel::printf("grid_position_of_B : %g", grid_position_of_B);
    Parallel::printf("current_position_of_A : %g", current_position_of_A);
    Parallel::printf("current_position_of_B : %g", current_position_of_B);
