...
struct Group {
  ...
  Options::String help = {"Options for recording data"};
};

/// The name of the H5 file on disk to which all volume data is written.
struct VolumeFileName {
  using type = std::string;
  Options::String help = {"Name of the volume data file without extension"};
  using group = Group;
};
...
struct ReductionFileName {
  using type = std::string;
  Options::String help = {"Name of the reduction data file without extension"};
  using group = Group;
};
...
struct SurfaceFileName {
  using type = std::string;
  Options::String help = {"Name of the surface data file without extension"};
  using group = Group;
};
}  // namespace OptionTags
