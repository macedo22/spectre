...
class BinaryCompactObject : public DomainCreator<3> {
 ...
 public:
  ...
  struct Object {
    Options::String help = {"Options for an object in a binary domain."};
    struct InnerRadius {
      using type = double;
      Options::String help = {"Inner coordinate radius of Layer 1."};
      static double lower_bound() { return 0.; }
    };
    struct OuterRadius {
      using type = double;
      Options::String help = {"Outer coordinate radius of Layer 1"};
      static double lower_bound() { return 0.; }
    };
    struct XCoord {
      using type = double;
      Options::String help = {"x-coordinate of center."};
    };
    struct Interior {
  ...
  struct EnvelopeRadius {
    ...
    using type = double;
    Options::String help = {"Radius of the sphere enveloping the two objects."};
  };

  struct OuterShell {
    Options::String help = {"Options for the outer spherical shell."};
  };
  ...
  struct OuterRadius {
    ...
    static std::string name() { return "Radius"; }
    using type = double;
    Options::String help = {"Radius of the entire domain."};
  };
  ...
  struct UseEquiangularMap {
    using type = bool;
    Options::String help = {"Distribute grid points equiangularly."};
