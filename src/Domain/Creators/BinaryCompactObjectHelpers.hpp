 ...
 public:
  ...
  struct ExpansionMapOptions {
    ...
    struct InitialValues {
      ...
      Options::String help = {"Initial value and deriv of expansion."};
    };
    struct AsymptoticVelocityOuterBoundary {
      using type = double;
      Options::String help = {"The asymptotic velocity of the outer boundary."};
    };
  ...
  struct RotationMapOptions {
    ...
    struct InitialAngularVelocity {
      using type = std::array<double, 3>;
      Options::String help = {"The initial angular velocity."};
    };
