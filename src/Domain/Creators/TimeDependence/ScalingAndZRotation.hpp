...
class ScalingAndZRotation final : public TimeDependence<MeshDim> {
 ...
 public:
  ...
  struct AngularVelocity {
    using type = double;
    Options::String help = {"The angular velocity of the map."};
  };
  ...
  struct OuterBoundary {
    using type = double;
    Options::String help = {"Outer boundary or pivot point of the map"};
  };
  /// \brief The initial values of the expansion factors.
  struct InitialExpansion {
    using type = std::array<double, 2>;
    Options::String help = {"Expansion values at initial time."};
  };
  /// \brief The velocity of the expansion factors.
  struct Velocity {
    using type = std::array<double, 2>;
    Options::String help = {"The rate of expansion."};
  };
  /// \brief The acceleration of the expansion factors.
  struct Acceleration {
    using type = std::array<double, 2>;
    Options::String help = {"The acceleration of expansion."};
  };
  /// \brief Whether to use linear scaling or cubic scaling.
  struct UseLinearScaling {
    using type = bool;
    Options::String help = {"Whether or not to turn on cubic scaling."};
  };
