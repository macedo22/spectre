...
class SphericalCompression final : public TimeDependence<3> {
 ...
 public:
  ...
  struct MinRadius {
    using type = double;
    static Options::String help = {"Min radius for SphericalCompression map."};
  };
  /// \brief Maximum radius for the SphericalCompression map
  struct MaxRadius {
    using type = double;
    static Options::String help = {"Max radius for SphericalCompression map."};
  };
  /// \brief Center for the SphericalCompression map
  struct Center {
    using type = std::array<double, 3>;
    static Options::String help = {"Center for the SphericalCompression map."};
  };
  ...
  static Options::String help = {"A spherical compression."};
