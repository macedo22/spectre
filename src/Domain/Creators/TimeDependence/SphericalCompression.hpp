...
class SphericalCompression final : public TimeDependence<3> {
 ...
 public:
  ...
  struct MinRadius {
    using type = double;
    Options::String help = {"Min radius for SphericalCompression map."};
  };
  /// \brief Maximum radius for the SphericalCompression map
  struct MaxRadius {
    using type = double;
    Options::String help = {"Max radius for SphericalCompression map."};
  };
  /// \brief Center for the SphericalCompression map
  struct Center {
    using type = std::array<double, 3>;
    Options::String help = {"Center for the SphericalCompression map."};
  };
  /// \brief Initial value for function of time for the spherical compression
  struct InitialValue {
    using type = double;
    Options::String help = {"Spherical compression value at initial time."};
  };
  /// \brief Initial radial velocity for the function of time for the spherical
  /// compression
  struct InitialVelocity {
    using type = double;
    Options::String help = {"Spherical compression initial radial velocity."};
  };
  ...
  Options::String help = {"A spherical compression."};
