...
struct LinearizedBondiSachs : public SphericalMetricData {
  struct InitialModes {
    ...
    Options::String help{"The initial modes of the Robinson-Trautman scalar"};
  };
  ...
  struct Frequency {
    using type = double;
    Options::String help{"The frequency of the linearized modes."};
    static type lower_bound() { return 0.0; }
  };

  Options::String help{"A linearized Bondi-Sachs analytic solution"};
