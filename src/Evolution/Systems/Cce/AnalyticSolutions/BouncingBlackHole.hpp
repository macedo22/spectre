...
struct BouncingBlackHole : public WorldtubeData {
  struct Amplitude {
    using type = double;
    Options::String help{"The coordinate distance of the gauge oscillation"};
  ...
  struct Mass {
    using type = double;
    Options::String help{"The mass of the Schwarzschild black hole"};
    static type lower_bound() { return 0.0; }
    static type suggested_value() { return 1.0; }
  };
  struct Period {
    using type = double;
    Options::String help{"The period of the coordinate oscillation"};
    static type lower_bound() { return 0.0; }
