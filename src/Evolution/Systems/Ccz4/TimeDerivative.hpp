 ...
 *
 * This evolution uses two binary settings that can be toggled. (1) If
...
struct TimeDerivative {
  static void apply(
      ...
      const bool evolve_shift, const bool use_harmonic_slicing_condition,
