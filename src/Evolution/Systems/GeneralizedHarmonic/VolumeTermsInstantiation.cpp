...
//           Variables<typename ::gh::System<DIM(data)>::gradient_variables>,    \
//           tmpl::size_t<DIM(data)>::value>*>                                   \
...
template void volume_terms<::gh::TimeDerivative<3>>(                
      const gsl::not_null<Variables<db::wrap_tags_in<                         
          ::Tags::dt,                                                        
          typename ::gh::System<3>::variables_tag::tags_list>>*>      
          dt_vars_ptr,                                                        
      const gsl::not_null<Variables<db::wrap_tags_in<                         
          ::Tags::Flux, typename ::gh::System<3>::flux_variables,     
          tmpl::size_t<3>, Frame::Inertial>>*>                        
          volume_fluxes,                                                      
    //   const gsl::not_null<std::array<                                         
    //       Variables<typename ::gh::System<3>::gradient_variables>,    
    //       tmpl::size_t<3>::value>*>                                   
    //       logical_partial_derivs,
      const gsl::not_null<std::array<                                         
          ...
          tmpl::size_t<3>::value>*>                                   
          logical_partial_derivs,                                            
      const gsl::not_null<Variables<typename ::gh::System<3>::compute_volume_time_derivative_terms::temporary_tags>*>     
          temporaries,                                                        
      const gsl::not_null<Variables<db::wrap_tags_in<                         
          ::Tags::div,                                                        
          db::wrap_tags_in<::Tags::Flux,                                      
                           typename ::gh::System<3>::flux_variables,  
                           tmpl::size_t<3>, Frame::Inertial>>>*>      
          div_fluxes,                                                         
      const Variables<typename ::gh::System<3>::variables_tag::tags_list>& evolved_vars,                    
