...
class TimeDependentTripleGaussian : public DampingFunction<3, Frame::Grid> {
 public:
  ...
  struct Gaussian {
    Options::String help = {"Parameters for one of the Gaussians."};
  ...
  struct Constant {
    using type = double;
    Options::String help = {"The constant."};
  };
  ...
  struct Amplitude {
    using group = Group;
    using type = double;
    Options::String help = {"The amplitude of the Gaussian."};
  };
  ...
  struct Width {
    using group = Group;
    using type = double;
    Options::String help = {"The unscaled width of the Gaussian."};
  ...
  struct Center {
    ...
    Options::String help = {"The center of the Gaussian."};
  };
