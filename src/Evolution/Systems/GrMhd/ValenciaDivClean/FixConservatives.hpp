...
class FixConservatives {
 public:
  ...
  struct CutoffD {
    using type = double;
    static type lower_bound() { return 0.0; }
    Options::String help = {"Cutoff below which D is set to MinimumValueOfD"};
  };
  /// \brief Minimum value of electron fraction \f$Y_e\f$
  struct MinimumValueOfYe {
    using type = double;
    static type lower_bound() { return 0.0; }
    Options::String help = {"Minimum value of electron fraction"};
  };
  ...
  struct SafetyFactorForB {
    using type = double;
    static type lower_bound() { return 0.0; }
    Options::String help = {"Safety factor for magnetic field bound."};
  };
  ...
  struct Enable {
    using type = bool;
    Options::String help = {"If true then the limiting is applied."};
  };
