...
class Weno<VolumeDim, tmpl::list<Tags...>> {
 public:
  ...
  struct Type {
    using type = WenoType;
    Options::String help = {"Type of WENO limiter"};
  };
  ...
  struct TvbConstant {
    ...
    Options::String help = {"TVB constant 'm'"};
  };
  ...
  struct DisableForDebugging {
    ...
    Options::String help = {"Disable the limiter"};
  };
  using options =
      tmpl::list<Type, NeighborWeight, TvbConstant, DisableForDebugging>;
  Options::String help = {"A WENO limiter for DG"};
