...
//   auto expected_d_lapse = make_with_value<tnsr::i<DataType, 3, Frame>>(x,
...
//   auto expected_d_shift = make_with_value<tnsr::iJ<DataType, 3, Frame>>(x,
//   0.0); for (size_t j = 0; j < 3; ++j) {
...
//         if (k == j) {
//           expected_d_g.get(k, i, j) += 2.0 * mass * x.get(i) *
//           one_over_r_cubed;
//         }
//         if (k == i) {
//           expected_d_g.get(k, i, j) += 2.0 * mass * x.get(j) *
//           one_over_r_cubed;
//         }
//       }
//     }
...
//               x, t,
//               tmpl::list<
//                   gr::Tags::DerivDetSpatialMetric<SpatialDim,
//                   FrameType>>{}));
...
//   gr::Solutions::KerrSchild::IntermediateVars<DataVector, FrameType>
//   ks_cache(
//       num_points_3d);
...
//   // the derivative of 1 / r well. This was looked at for various box sizes
//   and
