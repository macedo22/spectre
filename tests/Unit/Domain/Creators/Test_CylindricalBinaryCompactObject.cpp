...
void test_construction(
  ...
  if (block.is_time_dependent()) {
    ...
    // const auto& block_groups = creator.block_names();

    // // std::unordered_map<std::string, size_t> name_to_block_index_map;
    // std::array<std::string, size_t> block_to_group_name_map;
  ...
  // creator.external_boundary_conditions(); if (include_inner_sphere_A and
  // include_inner_sphere_B and
...
void test_cylindrical_bbh() {
  ...
  for (auto [include_outer_sphere, include_inner_sphere_A,
       ...
       //  random_sample<5>(
       //      cartesian_product(make_array(true, false), make_array(true,
       //      false),
       //                        make_array(true, false), make_array(true,
       //                        false), make_array(true, false),
       //                        make_array(true, false), make_array(true,
       //                        false), make_array(true, false),
       //                        make_array(true, false)),
       random_sample<5>(
           cartesian_product(make_array(true, true), make_array(true, true),
                             make_array(true, true), make_array(true, false),
