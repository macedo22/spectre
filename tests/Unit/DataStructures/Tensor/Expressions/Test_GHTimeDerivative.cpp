...
#include "Helpers/DataStructures/Tensor/Expressions/GHTimeDerivativeTestImpl.hpp"
...
void test_impl(const DataType& used_for_size,
               const gsl::not_null<Generator*> generator) noexcept {
  using GHTimeDerivativeImpl =
      TestHelpers::TensorExpressions::GHTimeDerivativeImpl<DataType, Dim>;
  using dt_spacetime_metric_type =
      typename GHTimeDerivativeImpl::dt_spacetime_metric_type;
  using dt_pi_type = typename GHTimeDerivativeImpl::dt_pi_type;
  using dt_phi_type = typename GHTimeDerivativeImpl::dt_phi_type;
  using temp_gamma1_type = typename GHTimeDerivativeImpl::temp_gamma1_type;
  using temp_gamma2_type = typename GHTimeDerivativeImpl::temp_gamma2_type;
  using gamma1gamma2_type = typename GHTimeDerivativeImpl::gamma1gamma2_type;
  using pi_two_normals_type =
      typename GHTimeDerivativeImpl::pi_two_normals_type;
  using normal_dot_gauge_constraint_type =
      typename GHTimeDerivativeImpl::normal_dot_gauge_constraint_type;
  using gamma1_plus_1_type = typename GHTimeDerivativeImpl::gamma1_plus_1_type;
  using pi_one_normal_type = typename GHTimeDerivativeImpl::pi_one_normal_type;
  using gauge_constraint_type =
      typename GHTimeDerivativeImpl::gauge_constraint_type;
  using phi_two_normals_type =
      typename GHTimeDerivativeImpl::phi_two_normals_type;
  using shift_dot_three_index_constraint_type =
      typename GHTimeDerivativeImpl::shift_dot_three_index_constraint_type;
  using phi_one_normal_type =
      typename GHTimeDerivativeImpl::phi_one_normal_type;
  using pi_2_up_type = typename GHTimeDerivativeImpl::pi_2_up_type;
  using three_index_constraint_type =
      typename GHTimeDerivativeImpl::three_index_constraint_type;
  using phi_1_up_type = typename GHTimeDerivativeImpl::phi_1_up_type;
  using phi_3_up_type = typename GHTimeDerivativeImpl::phi_3_up_type;
  using christoffel_first_kind_3_up_type =
      typename GHTimeDerivativeImpl::christoffel_first_kind_3_up_type;
  using lapse_type = typename GHTimeDerivativeImpl::lapse_type;
  using shift_type = typename GHTimeDerivativeImpl::shift_type;
  using spatial_metric_type =
      typename GHTimeDerivativeImpl::spatial_metric_type;
  using inverse_spatial_metric_type =
      typename GHTimeDerivativeImpl::inverse_spatial_metric_type;
  using det_spatial_metric_type =
      typename GHTimeDerivativeImpl::det_spatial_metric_type;
  using inverse_spacetime_metric_type =
      typename GHTimeDerivativeImpl::inverse_spacetime_metric_type;
  using christoffel_first_kind_type =
      typename GHTimeDerivativeImpl::christoffel_first_kind_type;
  using christoffel_second_kind_type =
      typename GHTimeDerivativeImpl::christoffel_second_kind_type;
  using trace_christoffel_type =
      typename GHTimeDerivativeImpl::trace_christoffel_type;
  using normal_spacetime_vector_type =
      typename GHTimeDerivativeImpl::normal_spacetime_vector_type;
  using normal_spacetime_one_form_type =
      typename GHTimeDerivativeImpl::normal_spacetime_one_form_type;
  using da_spacetime_metric_type =
      typename GHTimeDerivativeImpl::da_spacetime_metric_type;
  using d_spacetime_metric_type =
      typename GHTimeDerivativeImpl::d_spacetime_metric_type;
  using d_pi_type = typename GHTimeDerivativeImpl::d_pi_type;
  using d_phi_type = typename GHTimeDerivativeImpl::d_phi_type;
  using spacetime_metric_type =
      typename GHTimeDerivativeImpl::spacetime_metric_type;
  using pi_type = typename GHTimeDerivativeImpl::pi_type;
  using phi_type = typename GHTimeDerivativeImpl::phi_type;
  using gamma0_type = typename GHTimeDerivativeImpl::gamma0_type;
  using gamma1_type = typename GHTimeDerivativeImpl::gamma1_type;
  using gamma2_type = typename GHTimeDerivativeImpl::gamma2_type;
  using gauge_function_type =
      typename GHTimeDerivativeImpl::gauge_function_type;
  using spacetime_deriv_gauge_function_type =
      typename GHTimeDerivativeImpl::spacetime_deriv_gauge_function_type;
  ...
  GHTimeDerivativeImpl::manual_impl_lhs_arg(
  ...
  GHTimeDerivativeImpl::template tensorexpression_impl_lhs_arg<1>(
...
void test(const DataType& used_for_size,
          const gsl::not_null<Generator*> generator) noexcept {
  test_impl<1>(used_for_size, generator);
  test_impl<2>(used_for_size, generator);
  test_impl<3>(used_for_size, generator);
}
...
SPECTRE_TEST_CASE("Unit.Benchmark.GHTimeDerivative.all",
  ...
  test(std::numeric_limits<double>::signaling_NaN(), make_not_null(&generator));
