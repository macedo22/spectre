...
#include "Executables/Benchmark/GHTimeDerivative/normal_dot_gauge_constraint/BenchmarkedImpls.hpp"
...
void test_benchmarked_impls_core(
  ...
  TempBuffer<tmpl::list<::Tags::TempTensor<0, normal_dot_gauge_constraint_type>,
  ...
  BenchmarkImpl::template tensorexpression_impl_lhs_arg<1>(
      ...
      normal_spacetime_vector_te_temp, gauge_constraint_te_temp);
...
SPECTRE_TEST_CASE("Unit.Benchmark.GHTimeDerivative.normal_dot_gauge_constraint",
                  "[DataStructures][Unit]") {
