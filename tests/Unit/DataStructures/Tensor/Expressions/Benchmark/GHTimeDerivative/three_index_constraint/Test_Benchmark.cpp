...
#include "Executables/Benchmark/GHTimeDerivative/three_index_constraint/BenchmarkedImpls.hpp"
...
void test_benchmarked_impls_core(
  ...
  BenchmarkImpl::template tensorexpression_impl_lhs_arg<1>(
      ...
      d_spacetime_metric_te_temp, phi_te_temp);
  ...
  BenchmarkImpl::template tensorexpression_impl_lhs_arg<2>(
      make_not_null(&three_index_constraint_te2_temp),
      d_spacetime_metric_te_temp, phi_te_temp);
  ...
  BenchmarkImpl::template tensorexpression_impl_lhs_arg<3>(
      make_not_null(&three_index_constraint_te3_temp),
      d_spacetime_metric_te_temp, phi_te_temp);
  ...
  BenchmarkImpl::template tensorexpression_impl_lhs_arg<4>(
      make_not_null(&three_index_constraint_te4_temp),
      d_spacetime_metric_te_temp, phi_te_temp);
...
SPECTRE_TEST_CASE("Unit.Benchmark.GHTimeDerivative.three_index_constraint",
                  "[DataStructures][Unit]") {
