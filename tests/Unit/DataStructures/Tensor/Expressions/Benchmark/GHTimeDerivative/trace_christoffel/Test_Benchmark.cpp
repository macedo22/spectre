...
#include "Executables/Benchmark/GHTimeDerivative/trace_christoffel/BenchmarkedImpls.hpp"
...
void test_benchmarked_impls_core(
  ...
  BenchmarkImpl::template tensorexpression_impl_lhs_arg<2>(
      make_not_null(&trace_christoffel_te2_temp),
      christoffel_first_kind_te_temp, inverse_spacetime_metric_te_temp);
...
SPECTRE_TEST_CASE("Unit.Benchmark.GHTimeDerivative.trace_christoffel",
                  "[DataStructures][Unit]") {
