...
#include "Executables/Benchmark/GHTimeDerivative/dt_spacetime_metric/BenchmarkedImpls.hpp"
...
void test_benchmarked_impls_core(
  ...
  BenchmarkImpl::template tensorexpression_impl_lhs_arg<1>(
      make_not_null(&dt_spacetime_metric_te1_temp), lapse_te_temp, pi_te_temp,
      gamma1_plus_1_te_temp, shift_dot_three_index_constraint_te_temp,
      shift_te_temp, phi_te_temp);
  ...
  BenchmarkImpl::template tensorexpression_impl_lhs_arg<2>(
      make_not_null(&dt_spacetime_metric_te2_temp), lapse_te_temp, pi_te_temp,
      gamma1_plus_1_te_temp, shift_dot_three_index_constraint_te_temp,
      shift_te_temp, phi_te_temp);
  ...
  BenchmarkImpl::template tensorexpression_impl_lhs_arg<3>(
      make_not_null(&dt_spacetime_metric_te3_temp), lapse_te_temp, pi_te_temp,
      gamma1_plus_1_te_temp, shift_dot_three_index_constraint_te_temp,
      shift_te_temp, phi_te_temp);
  ...
  BenchmarkImpl::template tensorexpression_impl_lhs_arg<4>(
      make_not_null(&dt_spacetime_metric_te4_temp), lapse_te_temp, pi_te_temp,
      gamma1_plus_1_te_temp, shift_dot_three_index_constraint_te_temp,
      shift_te_temp, phi_te_temp);
  ...
  BenchmarkImpl::template tensorexpression_impl_lhs_arg<5>(
      make_not_null(&dt_spacetime_metric_te5_temp), lapse_te_temp, pi_te_temp,
      gamma1_plus_1_te_temp, shift_dot_three_index_constraint_te_temp,
      shift_te_temp, phi_te_temp);
...
SPECTRE_TEST_CASE("Unit.Benchmark.GHTimeDerivative.dt_spacetime_metric",
                  "[DataStructures][Unit]") {
