...
SPECTRE_TEST_CASE("Unit.DataStructures.Tensor.Expression.OuterProduct0By2",
  ...
  auto L_ab =
      TensorExpressions::evaluate<ti_a_t, ti_b_t>(R() * Sll(ti_a, ti_b));
...
SPECTRE_TEST_CASE("Unit.DataStructures.Tensor.Expression.InnerProduct2By2By2",
  ...
  // TODO : need to resolve rank 5 tensor issue for this below case:
  ...
  //td<decltype(test)::args_list> idk2;
...
// // TODO: can't do this because indices > 4
...
SPECTRE_TEST_CASE("Unit.DataStructures.Tensor.Expression.InnerOuterProduct",
  ...
  auto L_Aab_to_b =
      TensorExpressions::evaluate<ti_b_t>(Ru(ti_A) * Sl(ti_a) * Tl(ti_b));
  ...
  auto L_Aabc_to_bc = TensorExpressions::evaluate<ti_b_t, ti_c_t>(
