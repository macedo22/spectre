...
#include "DataStructures/Tensor/Expressions/CustomStaticSizeVector.hpp"
...
constexpr size_t custom_vector_static_size =
    CustomStaticSizeVector::static_size;
...
SPECTRE_TEST_CASE("Unit.DataStructures.Tensor.Expression.DataTypeSupport",
  ...
  test_upcast_if_derived_vector_type<
      ...
      VectorImpl<std::complex<double>, CustomStaticSizeVector,
  ...
  test_get_complex_datatype<CustomStaticSizeVector, NoSuchType>();
  ...
  test_is_assignable<double, CustomStaticSizeVector>(false);
  ...
  test_is_assignable<std::complex<double>, CustomStaticSizeVector>(false);
  ...
  test_is_assignable<DataVector, CustomStaticSizeVector>(false);
  ...
  test_is_assignable<ComplexDataVector, CustomStaticSizeVector>(false);
  test_is_assignable<ComplexDataVector, ArbitraryType>(false);

  test_is_assignable<CustomStaticSizeVector, double>(true);
  test_is_assignable<CustomStaticSizeVector, std::complex<double>>(true);
  test_is_assignable<CustomStaticSizeVector, DataVector>(false);
  test_is_assignable<CustomStaticSizeVector, ComplexDataVector>(false);
  test_is_assignable<CustomStaticSizeVector, CustomStaticSizeVector>(true);
  test_is_assignable<CustomStaticSizeVector, ArbitraryType>(false);
  ...
  test_is_assignable<ArbitraryType, CustomStaticSizeVector>(false);
  ...
  test_binop_datatype_support<double, CustomStaticSizeVector,
                              CustomStaticSizeVector>();
  ...
  test_binop_datatype_support<std::complex<double>, ComplexDataVector,
                              ComplexDataVector>();
  test_binop_datatype_support<std::complex<double>, CustomStaticSizeVector,
                              CustomStaticSizeVector>();
  ...
  test_binop_datatype_support<DataVector, ComplexDataVector,
                              ComplexDataVector>();
  test_binop_datatype_support<DataVector, CustomStaticSizeVector, NoSuchType>();
  ...
  test_binop_datatype_support<ComplexDataVector, ComplexDataVector,
                              ComplexDataVector>();
  test_binop_datatype_support<ComplexDataVector, CustomStaticSizeVector,
                              NoSuchType>();
  ...
  test_binop_datatype_support<CustomStaticSizeVector, double,
                              CustomStaticSizeVector>();
  test_binop_datatype_support<CustomStaticSizeVector, std::complex<double>,
                              CustomStaticSizeVector>();
  test_binop_datatype_support<CustomStaticSizeVector, DataVector, NoSuchType>();
  test_binop_datatype_support<CustomStaticSizeVector, ComplexDataVector,
                              NoSuchType>();
  test_binop_datatype_support<CustomStaticSizeVector, ArbitraryType,
                              NoSuchType>();
  test_binop_datatype_support<CustomStaticSizeVector, CustomStaticSizeVector,
                              CustomStaticSizeVector>();
  test_binop_datatype_support<CustomStaticSizeVector, NoSuchType, NoSuchType>();
  ...
  test_binop_datatype_support<ArbitraryType, CustomStaticSizeVector,
                              NoSuchType>();
  ...
  test_binop_datatype_support<NoSuchType, CustomStaticSizeVector, NoSuchType>();
