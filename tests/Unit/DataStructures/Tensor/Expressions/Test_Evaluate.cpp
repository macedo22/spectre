...
SPECTRE_TEST_CASE("Unit.DataStructures.Tensor.Expression.Evaluate",
  ...
  // Maximum resident set size (kbytes): 469400

  // compile command used:
  // /usr/bin/time -v /opt/ohpc/pub/compiler/gcc/11.3.0/bin/g++ -DBLAZE_BLAS_INCLUDE_FILE="<gsl/gsl_cblas.h>" -DBLAZE_BLAS_MODE=1 -DBLAZE_DEFAULT_STORAGE_ORDER=blaze::columnMajor -DBLAZE_MPI_PARALLEL_MODE=0 -DBLAZE_USE_ALWAYS_INLINE=1 -DBLAZE_USE_DEFAULT_INITIALIZATON=0 -DBLAZE_USE_PADDING=0 -DBLAZE_USE_SHARED_MEMORY_PARALLELIZATION=0 -DBLAZE_USE_SLEEF=0 -DBLAZE_USE_STREAMING=1 -DBLAZE_USE_STRONG_INLINE=1 -DBOOST_ALLOW_DEPRECATED_HEADERS -DBOOST_MULTI_ARRAY_TYPES_HPP -DBOOST_PROGRAM_OPTIONS_DYN_LINK -DBOOST_PROGRAM_OPTIONS_NO_LIB -DBOOST_SP_DISABLE_THREADS -DDISABLE_OPENBLAS_MULTITHREADING -DH5_BUILT_AS_DYNAMIC_LIB -DSPECTRE_USE_ALWAYS_INLINE=1 -DTest_Expressions_EXPORTS -D_FILE_OFFSET_BITS=64 -D_GNU_SOURCE -D_LARGEFILE64_SOURCE -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200809L -I/home/alexmacedo/spectre/src -I/home/alexmacedo/spectre/tests/Unit -isystem /home/alexmacedo/spectre/build_te/src -isystem /home/alexmacedo/spectre/build_te/tests/Unit -isystem /opt/ohpc/pub/apps/spack2022/opt/spack/linux-centos7-broadwell/gcc-11.3.0/jemalloc-5.2.1-r63hempegqym5ahitm2ykc3x7x4wvkci/include -isystem /opt/ohpc/pub/apps/spack2022/opt/spack/linux-centos7-broadwell/gcc-11.3.0/blaze-3.8-y7sgzzcyehq7nosikgmqoi57pf5g2rpv/include -isystem /opt/ohpc/pub/apps/spack2022/opt/spack/linux-centos7-broadwell/gcc-11.3.0/gsl-2.7.1-sey3z3ovrt3f4gvelm6dels7elkugo7o/include -isystem /home/alexmacedo/spectre/external/brigand/include -isystem /opt/ohpc/pub/apps/charm_7.0.0_gnu11_022324/verbs-linux-x86_64-smp-gcc/include -isystem /opt/ohpc/pub/apps/spack2022/opt/spack/linux-centos7-broadwell/gcc-11.3.0/hdf5-1.12.2-dly2yyupjmeqjt5qswpt6iwuun7gvml3/include -isystem /opt/ohpc/pub/mpi/openmpi-gnu11/4.1.4/include -isystem /opt/ohpc/pub/apps/catch2/3.4.0/include -isystem /opt/ohpc/pub/apps/spack2022/opt/spack/linux-centos7-broadwell/gcc-11.3.0/boost-1.79.0-ck2cccntuidtdby5falg4dooac6c7ypj/include -isystem /opt/ohpc/pub/apps/libxsmm/1.16.1/include -isystem /opt/ohpc/pub/apps/spack2022/opt/spack/linux-centos7-broadwell/gcc-11.3.0/yaml-cpp-0.7.0-a4rumor7dkzoxmila6ewami7fzvoggwl/include -isystem /opt/ohpc/pub/apps/python/3.9.5/lib/python3.9/site-packages/numpy/core/include -isystem /opt/ohpc/pub/apps/python/3.9.5/include/python3.9 -O3 -DNDEBUG -fPIC -march=native -mno-avx512f -ftemplate-backtrace-limit=0 -Wno-interference-size -fno-math-errno -freciprocal-math -W -Wall -Wcast-align -Wcast-qual -Wdisabled-optimization -Wextra -Wformat-nonliteral -Wformat-security -Wformat-y2k -Wformat=2 -Winvalid-pch -Wmissing-declarations -Wmissing-field-initializers -Wmissing-format-attribute -Wmissing-include-dirs -Wmissing-noreturn -Wno-mismatched-tags -Wno-non-template-friend -Wno-type-limits -Wnon-virtual-dtor -Wold-style-cast -Woverloaded-virtual -Wpacked -Wpedantic -Wpointer-arith -Wredundant-decls -Wshadow -Wsign-conversion -Wstack-protector -Wswitch-default -Wunreachable-code -Wwrite-strings -Wno-noexcept-type -Wno-unknown-pragmas -fnon-call-exceptions -pthread -std=c++20 -Winvalid-pch -include /home/alexmacedo/spectre/build_te/CMakeFiles/SpectrePch.dir/cmake_pch.hxx -o CMakeFiles/Test_Expressions.dir/Test_Evaluate.cpp.o -c /home/alexmacedo/spectre/tests/Unit/DataStructures/Tensor/Expressions/Test_Evaluate.cpp
}
