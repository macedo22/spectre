...
SPECTRE_TEST_CASE("Unit.DataStructures.Tensor.Expression.Evaluate",
  ...
  TestHelpers::tenex::test_evaluate_rank_1<double, SpacetimeIndex, ti::a, Frame::Inertial>();
  TestHelpers::tenex::test_evaluate_rank_1<double, SpacetimeIndex, ti::b, Frame::Grid>();
  TestHelpers::tenex::test_evaluate_rank_1<double, SpacetimeIndex, ti::A, Frame::Inertial>();
  TestHelpers::tenex::test_evaluate_rank_1<double, SpacetimeIndex, ti::B, Frame::Grid>();

  // Rank 1: double; DataVector
  TestHelpers::tenex::test_evaluate_rank_1<double, SpatialIndex, ti::i, Frame::Grid>();
  TestHelpers::tenex::test_evaluate_rank_1<double, SpatialIndex, ti::j, Frame::Inertial>();
  TestHelpers::tenex::test_evaluate_rank_1<double, SpatialIndex, ti::I, Frame::Grid>();
  TestHelpers::tenex::test_evaluate_rank_1<double, SpatialIndex, ti::J, Frame::Inertial>();
  ...
  TestHelpers::tenex::test_evaluate_rank_2_no_symmetry<
      double, SpacetimeIndex, SpacetimeIndex, ti::D, ti::C, Frame::Inertial>();
  TestHelpers::tenex::test_evaluate_rank_2_no_symmetry<
